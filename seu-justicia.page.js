...
const MIC_SPECS = [{
  ca: 'Micròfons de coll de cigne professionals integrats a l\'ecosistema Bose Professional',
  es: 'Micrófonos de cuello de cisne profesionales integrados en el ecosistema Bose Professional',
  fr: 'Microphones col-de-cygne professionnels intégrés à l\'écosystème Bose Professional',
  en: 'Professional gooseneck microphones integrated into the Bose Professional ecosystem'
}, {
  ca: 'Cancel·lació d\'eco automàtica (AEC) integrada al processador',
  es: 'Cancelación de eco automática (AEC) integrada en el procesador',
  fr: 'Annulation d\'écho automatique (AEC) intégrée au processeur',
  en: 'Automatic echo cancellation (AEC) integrated in the processor'
}, {
  ...
  ca: 'Processador DSP Bose ControlSpace per a gestió de sala',
  es: 'Procesador DSP Bose ControlSpace para gestión de sala',
  fr: 'Processeur DSP Bose ControlSpace pour gestion de salle',
  en: 'Bose ControlSpace DSP processor for room management'
}, {
  ca: 'Activació automàtica i muting individual per posició',
  es: 'Activación automática y muting individual por posición',
  fr: 'Activation automatique et muting individuel par position',
  en: 'Automatic activation and individual muting per position'
}];
const HOTSPOTS = [{
  id: 'estrat',
  n: '01',
  ...
  title: {
    ca: 'Microfonia de l\'Estrat',
    es: 'Microfonía del Estrado',
    fr: 'Microphones de l\'Estrade',
    en: 'Bench Microphone System'
  },
  desc: {
  ...
  y: '27%',
  label: {
    ca: 'Bancada Advocats I',
    es: 'Bancada Abogados I',
    fr: 'Banc des Avocats I',
    en: 'Lawyers Bench I'
  },
  title: {
    ca: 'Microfonia dels Advocats',
    es: 'Microfonía de los Abogados',
    fr: 'Microphones des Avocats',
    en: 'Lawyers Microphones'
  },
  desc: {
    ca: "La primera bancada dels advocats disposa de micròfons individuals per a cada lletrat, permetent que les intervencions de les parts quedin recollides amb total claredat i sense interferències.",
    es: "La primera bancada de los abogados dispone de micrófonos individuales para cada letrado, permitiendo que las intervenciones de las partes queden recogidas con total claridad y sin interferencias.",
    fr: "Le premier banc des avocats dispose de microphones individuels pour chaque avocat, permettant de recueillir les interventions des parties avec une clarté totale et sans interférences.",
    en: "The first lawyers bench has individual microphones for each counsel, so the parties' interventions are captured with full clarity and free of interference."
  },
  specs: MIC_SPECS,
  color: '#4f9e2f'
}, {
  ...
  y: '29%',
  label: {
    ca: 'Bancada Advocats II',
    es: 'Bancada Abogados II',
    fr: 'Banc des Avocats II',
    en: 'Lawyers Bench II'
  },
  title: {
    ca: 'Microfonia dels Advocats',
  ...
  desc: {
    ca: "La segona bancada dels advocats compta amb micròfons propis per a cada lletrat, amb la mateixa qualitat de captació i activació automàtica que la resta de posicions de la sala.",
    es: "La segunda bancada de los abogados cuenta con micrófonos propios para cada letrado, con la misma calidad de captación y activación automática que el resto de posiciones de la sala.",
    fr: "Le second banc des avocats dispose de microphones propres pour chaque avocat, avec la même qualité de captation et activation automatique que les autres positions de la salle.",
    en: "The second lawyers bench has its own microphones for each counsel, with the same capture quality and automatic activation as the rest of the room's positions."
  },
  specs: MIC_SPECS,
  color: '#4f9e2f'
}, {
  ...
  label: {
    ...
    es: 'Bancada Fiscalía',
    fr: 'Banc du Parquet',
    en: 'Prosecution Bench'
  },
  title: {
    ca: 'Microfonia de la Fiscalia',
    es: 'Microfonía de la Fiscalía',
    fr: 'Microphones du Parquet',
    en: 'Prosecution Microphones'
  },
  desc: {
    ca: "La bancada de la Fiscalia incorpora micròfons de coll de cigne dedicats que asseguren una captació nítida de les intervencions del ministeri fiscal, integrats en el mateix sistema digital de sala i amb activació automàtica.",
    es: "La bancada de la Fiscalía incorpora micrófonos de cuello de cisne dedicados que aseguran una captación nítida de las intervenciones del ministerio fiscal, integrados en el mismo sistema digital de sala y con activación automática.",
    fr: "Le banc du parquet intègre des microphones col-de-cygne dédiés assurant une captation nette des interventions du ministère public, intégrés au même système numérique de salle avec activation automatique.",
    en: "The prosecution bench features dedicated gooseneck microphones ensuring clear capture of the prosecution's interventions, integrated into the same digital room system with automatic activation."
  },
  specs: MIC_SPECS,
  color: '#4f9e2f'
}, {
  ...
  specs: [{
    ca: 'Altaveus de sostre Bose Professional d\'alta intel·ligibilitat',
    es: 'Altavoces de techo Bose Professional de alta inteligibilidad',
    fr: 'Haut-parleurs de plafond Bose Professional à haute intelligibilité',
    en: 'Bose Professional high-intelligibility ceiling speakers'
  }, {
    ca: 'Amplificadors Bose PowerSpace amb processament integrat',
    es: 'Amplificadores Bose PowerSpace con procesamiento integrado',
    fr: 'Amplificateurs Bose PowerSpace avec traitement intégré',
    en: 'Bose PowerSpace amplifiers with integrated processing'
  }, {
    ca: 'Processament i gestió d\'àudio Bose ControlSpace',
    es: 'Procesamiento y gestión de audio Bose ControlSpace',
    fr: 'Traitement et gestion audio Bose ControlSpace',
    en: 'Bose ControlSpace audio processing and management'
  }, {
    ca: 'Tractament acústic per a una distribució uniforme del so',
    es: 'Tratamiento acústico para una distribución uniforme del sonido',
    fr: 'Traitement acoustique pour une distribution uniforme du son',
    en: 'Acoustic treatment for uniform sound distribution'
  }, {
