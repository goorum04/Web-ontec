...
const MIC_SPECS = [{
  ca: 'Micròfons de coll de cigne Shure professionals per posició',
  es: 'Micrófonos de cuello de cisne Shure profesionales por posición',
  fr: 'Microphones col-de-cygne Shure professionnels par position',
  en: 'Professional Shure gooseneck microphones per position'
}, {
