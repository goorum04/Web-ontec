...
const PARTNERS = [
  {name:'Zyxel',cat:{ca:'Ciberseguretat',es:'Ciberseguridad',fr:'Cybersécurité',en:'Cybersecurity'},desc:{ca:"Firewalls i xarxes segures per a empreses.",es:"Firewalls y redes seguras para empresas.",fr:"Pare-feu et réseaux sécurisés pour les entreprises.",en:"Firewalls and secure networks for businesses."}},
