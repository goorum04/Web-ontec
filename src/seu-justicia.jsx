...
const HOTSPOTS = [
  ...
  },
  {
    ...
    x: '50%',
    y: '27%',
    label: { ca: 'Bancada Advocats I', es: 'Bancada Abogados I', fr: 'Banc des Avocats I', en: 'Lawyers Bench I' },
  ...
  },
  {
    ...
    x: '56%',
    y: '29%',
    label: { ca: 'Bancada Advocats II', es: 'Bancada Abogados II', fr: 'Banc des Avocats II', en: 'Lawyers Bench II' },
    title: { ca: 'Microfonia dels Advocats', es: 'Microfonía de los Abogados', fr: 'Microphones des Avocats', en: 'Lawyers Microphones' },
    desc: {
