...
function CiberseguretatIncibe() {
  const threats=[
    {icon:<Icons.Shield/>,t:{ca:'Firewall avançat',es:'Firewall avanzado',fr:'Pare-feu avancé',en:'Advanced firewall'},d:{ca:'Zyxel & Palo Alto Networks de nova generació.',es:'Zyxel & Palo Alto Networks de nueva generación.',fr:'Zyxel & Palo Alto Networks nouvelle génération.',en:'Next-generation Zyxel & Palo Alto Networks.'}},
