    ...
    <LegalLayout
      ...
      {tt({
        ca:<>
          ...
          <p>ON TECNOLOGIES S.L. — C/ de la Vena 3, Baixos, Encamp, Andorra — <MailLink/> — +376 88 55 99.</p>
          ...
          <p>Pots exercir els drets d'<strong>accés, rectificació, supressió, oposició, limitació i portabilitat</strong> escrivint a <MailLink/>. També tens dret a presentar una reclamació davant l'<strong>Agència Andorrana de Protecció de Dades (APDA)</strong> — apda.ad.</p>
        ...
        es:<>
          ...
          <p>ON TECNOLOGIES S.L. — C/ de la Vena 3, Bajos, Encamp, Andorra — <MailLink/> — +376 88 55 99.</p>
          ...
          <p>Puedes ejercer los derechos de <strong>acceso, rectificación, supresión, oposición, limitación y portabilidad</strong> escribiendo a <MailLink/>. También tienes derecho a presentar una reclamación ante la <strong>Agencia Andorrana de Protección de Datos (APDA)</strong> — apda.ad.</p>
        ...
        fr:<>
          ...
          <p>ON TECNOLOGIES S.L. — C/ de la Vena 3, Baixos, Encamp, Andorre — <MailLink/> — +376 88 55 99.</p>
          ...
          <h2>7. Vos droits</h2>
          <p>Vous pouvez exercer vos droits d'<strong>accès, de rectification, d'effacement, d'opposition, de limitation et de portabilité</strong> en écrivant à <MailLink/>. Vous avez également le droit d'introduire une réclamation auprès de l'<strong>Agence andorrane de protection des données (APDA)</strong> — apda.ad.</p>
        ...
        en:<>
          ...
          <h2>7. Your rights</h2>
          <p>You can exercise your rights of <strong>access, rectification, erasure, objection, restriction and portability</strong> by writing to <MailLink/>. You also have the right to lodge a complaint with the <strong>Andorran Data Protection Agency (APDA)</strong> — apda.ad.</p>
