...
function App() {
  ...
  return /*#__PURE__*/React.createElement(LegalLayout, {
    activePage: "",
    kicker: tt({
      ca: 'Cookies i emmagatzematge',
      es: 'Cookies y almacenamiento',
      fr: 'Cookies et stockage',
      en: 'Cookies and storage'
    }),
    title: tt({
    ...
    ca: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, "1. Aquest lloc no fa servir cookies de seguiment"), /*#__PURE__*/React.createElement("p", null, "Ontec ", /*#__PURE__*/React.createElement("strong", null, "no utilitza cookies publicitàries, d'analítica ni de seguiment"), ". No fem servir Google Analytics, píxels de xarxes socials ni cap eina de rastreig del comportament dels visitants."), /*#__PURE__*/React.createElement("h2", null, "2. Emmagatzematge tècnic local"), /*#__PURE__*/React.createElement("p", null, "Per millorar la teva experiència, el lloc desa una única preferència al teu navegador mitjançant ", /*#__PURE__*/React.createElement("em", null, "localStorage"), ":"), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Idioma (ontec_lang):"), " recorda l'idioma que has triat (català, espanyol, francès o anglès).")), /*#__PURE__*/React.createElement("p", null, "Aquesta informació es desa només al teu dispositiu, no s'envia enlloc i no permet identificar-te. Per aquest motiu no requereix consentiment."), /*#__PURE__*/React.createElement("h2", null, "3. Serveis de tercers"), /*#__PURE__*/React.createElement("p", null, "El lloc carrega alguns recursos externs (tipografies, llibreries tècniques i imatges) des de proveïdors com Google Fonts, jsDelivr o Unsplash. En carregar-los, aquests proveïdors poden registrar la teva adreça IP per motius tècnics. No instal·len cookies de seguiment en nom d'Ontec."), /*#__PURE__*/React.createElement("h2", null, "4. Com gestionar o eliminar l'emmagatzematge"), /*#__PURE__*/React.createElement("p", null, "Pots esborrar les dades emmagatzemades en qualsevol moment des de la configuració del teu navegador (esborrar dades de navegació / dades de llocs). També pots navegar en mode privat/incògnit perquè no es desi res."), /*#__PURE__*/React.createElement("h2", null, "5. Canvis"), /*#__PURE__*/React.createElement("p", null, "Podem actualitzar aquesta política si en el futur incorporem noves funcionalitats. Et recomanem revisar-la periòdicament.")),
    es: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, "1. Este sitio no usa cookies de seguimiento"), /*#__PURE__*/React.createElement("p", null, "Ontec ", /*#__PURE__*/React.createElement("strong", null, "no utiliza cookies publicitarias, de analítica ni de seguimiento"), ". No usamos Google Analytics, píxeles de redes sociales ni ninguna herramienta de rastreo del comportamiento de los visitantes."), /*#__PURE__*/React.createElement("h2", null, "2. Almacenamiento técnico local"), /*#__PURE__*/React.createElement("p", null, "Para mejorar tu experiencia, el sitio guarda una única preferencia en tu navegador mediante ", /*#__PURE__*/React.createElement("em", null, "localStorage"), ":"), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Idioma (ontec_lang):"), " recuerda el idioma que has elegido (catalán, español, francés o inglés).")), /*#__PURE__*/React.createElement("p", null, "Esta información se guarda solo en tu dispositivo, no se envía a ningún sitio y no permite identificarte. Por ello no requiere consentimiento."), /*#__PURE__*/React.createElement("h2", null, "3. Servicios de terceros"), /*#__PURE__*/React.createElement("p", null, "El sitio carga algunos recursos externos (tipografías, librerías técnicas e imágenes) desde proveedores como Google Fonts, jsDelivr o Unsplash. Al cargarlos, dichos proveedores pueden registrar tu dirección IP por motivos técnicos. No instalan cookies de seguimiento en nombre de Ontec."), /*#__PURE__*/React.createElement("h2", null, "4. Cómo gestionar o eliminar el almacenamiento"), /*#__PURE__*/React.createElement("p", null, "Puedes borrar los datos almacenados en cualquier momento desde la configuración de tu navegador (borrar datos de navegación / datos de sitios). También puedes navegar en modo privado/incógnito para que no se guarde nada."), /*#__PURE__*/React.createElement("h2", null, "5. Cambios"), /*#__PURE__*/React.createElement("p", null, "Podemos actualizar esta política si en el futuro incorporamos nuevas funcionalidades. Te recomendamos revisarla periódicamente.")),
    fr: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, "1. Ce site n'utilise pas de cookies de suivi"), /*#__PURE__*/React.createElement("p", null, "Ontec ", /*#__PURE__*/React.createElement("strong", null, "n'utilise pas de cookies publicitaires, d'analyse ni de suivi"), ". Nous n'utilisons ni Google Analytics, ni pixels de réseaux sociaux, ni aucun outil de suivi du comportement des visiteurs."), /*#__PURE__*/React.createElement("h2", null, "2. Stockage technique local"), /*#__PURE__*/React.createElement("p", null, "Pour améliorer votre expérience, le site enregistre une seule préférence dans votre navigateur via ", /*#__PURE__*/React.createElement("em", null, "localStorage"), " :"), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Langue (ontec_lang) :"), " mémorise la langue choisie (catalan, espagnol, français ou anglais).")), /*#__PURE__*/React.createElement("p", null, "Cette information est enregistrée uniquement sur votre appareil, n'est envoyée nulle part et ne permet pas de vous identifier. Elle ne nécessite donc pas de consentement."), /*#__PURE__*/React.createElement("h2", null, "3. Services tiers"), /*#__PURE__*/React.createElement("p", null, "Le site charge certaines ressources externes (polices, bibliothèques techniques et images) depuis des fournisseurs tels que Google Fonts, jsDelivr ou Unsplash. Lors de leur chargement, ces fournisseurs peuvent enregistrer votre adresse IP pour des raisons techniques. Ils n'installent pas de cookies de suivi au nom d'Ontec."), /*#__PURE__*/React.createElement("h2", null, "4. Comment gérer ou supprimer le stockage"), /*#__PURE__*/React.createElement("p", null, "Vous pouvez effacer les données stockées à tout moment depuis les paramètres de votre navigateur (effacer les données de navigation / données de sites). Vous pouvez aussi naviguer en mode privé pour que rien ne soit enregistré."), /*#__PURE__*/React.createElement("h2", null, "5. Modifications"), /*#__PURE__*/React.createElement("p", null, "Nous pouvons mettre à jour cette politique si de nouvelles fonctionnalités sont ajoutées à l'avenir. Nous vous recommandons de la consulter régulièrement.")),
    en: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, "1. This site does not use tracking cookies"), /*#__PURE__*/React.createElement("p", null, "Ontec ", /*#__PURE__*/React.createElement("strong", null, "does not use advertising, analytics or tracking cookies"), ". We do not use Google Analytics, social media pixels or any visitor-behaviour tracking tools."), /*#__PURE__*/React.createElement("h2", null, "2. Local technical storage"), /*#__PURE__*/React.createElement("p", null, "To improve your experience, the site stores a single preference in your browser via ", /*#__PURE__*/React.createElement("em", null, "localStorage"), ":"), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Language (ontec_lang):"), " remembers the language you chose (Catalan, Spanish, French or English).")), /*#__PURE__*/React.createElement("p", null, "This information is stored only on your device, is not sent anywhere and cannot identify you. It therefore does not require consent."), /*#__PURE__*/React.createElement("h2", null, "3. Third-party services"), /*#__PURE__*/React.createElement("p", null, "The site loads some external resources (fonts, technical libraries and images) from providers such as Google Fonts, jsDelivr or Unsplash. When loading them, these providers may record your IP address for technical reasons. They do not install tracking cookies on behalf of Ontec."), /*#__PURE__*/React.createElement("h2", null, "4. How to manage or delete storage"), /*#__PURE__*/React.createElement("p", null, "You can delete the stored data at any time from your browser settings (clear browsing data / site data). You can also browse in private/incognito mode so nothing is saved."), /*#__PURE__*/React.createElement("h2", null, "5. Changes"), /*#__PURE__*/React.createElement("p", null, "We may update this policy if new features are added in the future. We recommend reviewing it periodically."))
  }));
}
