...
function ContactForm() {
  ...
  const field = (label, key, type = 'text', req = false, placeholder = '') => /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, /*#__PURE__*/React.createElement(Icons.Check, null)), /*#__PURE__*/React.createElement("h3", {
    className: "disp",
    style: {
      fontSize: 36,
      marginBottom: 16
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    style: {
      ...
      padding: '14px 18px',
      fontSize: 15,
      color: form.servei ? 'var(--ink)' : 'var(--mut)',
      outline: 'none',
      fontFamily: 'var(--body)',
      cursor: 'pointer'
    }
...
function App() {
  ...
  }, item.label), item.mail ? /*#__PURE__*/React.createElement(MailLink, {
    style: {
      fontSize: 16,
      color: 'var(--ink)',
      textDecoration: 'none'
  ...
  }, item.val))))))), /*#__PURE__*/React.createElement(Reveal, {
    delay: 200
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--panel)',
  ...
  }, h)))))))), /*#__PURE__*/React.createElement("style", null, `@media(max-width:920px){.contact-grid{grid-template-columns:1fr!important;}}`)));
}
